  ...
  java.io.Serializable
{
  ...
  private E doRemove(Object okey, Object value)
  {
    ...
    for (; ; )
    {
      ...
      for (; ; )
      {
        ...
        NodeRemoval nodeRemoval = new NodeRemoval(key, b, n).invoke();

        if (nodeRemoval.is())
          break;

        int c = nodeRemoval.getC();
        Node<E> f = nodeRemoval.getF();
        Object v = nodeRemoval.getV();
  ...
  private class NodeRemoval
  {
    private boolean myResult;
    private Comparable<? super E> key;
    private Node<E> b;
    private Node<E> n;
    private Node<E> f;
    private Object v;
    ...
    public NodeRemoval(Comparable<? super E> key, Node<E> b, Node<E> n)
    {
      this.key = key;
      this.b = b;
      this.n = n;
